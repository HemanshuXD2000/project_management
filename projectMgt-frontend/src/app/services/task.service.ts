...
export class TaskService {
  ...
  constructor(private http: HttpClient) {
    this.taskUrl='http://localhost:9000/ADMIN-VIEW-SERVICE/api/v1/getTasks';
    this.taskURL2 = 'http://localhost:9000/MANAGER-SERVICE/task/TaskByProjectId';
    this.saveTaskURL = 'http://localhost:9005/task/Task';
  }
