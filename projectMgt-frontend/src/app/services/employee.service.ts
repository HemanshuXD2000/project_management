...
export class EmployeeService {
  ...
  constructor(private http: HttpClient) {
    this.employeeUrl = 'http://localhost:9000/ADMIN-VIEW-SERVICE/api/v1/search';
    this.memberUrl = 'http://localhost:9000/ADMIN-VIEW-SERVICE/api/v1/getteams';
    this.managerURL = 'http://localhost:9000/MANAGER-SERVICE/employee/getManagersByAvailability';
    this.skilledEmployeeURL = 'http://localhost:9000/MANAGER-SERVICE/employeeSkill/getEmployeesBySkills';
    this.employeeURL = 'http://localhost:9000/MANAGER-SERVICE/employee/getMembersByAvailability';
