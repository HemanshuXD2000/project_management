...
export class ProjectmemberService {
  ...
  constructor(private http: HttpClient) {
    this.projectMemberUrl = 'http://localhost:9005/projectMember/saveProjectMember';
    this.assignedMemberUrl = 'http://localhost:9000/MANAGER-SERVICE/projectMember/getAllMembersOfAProject';
    this.allProjectMemberUrl = 'http://localhost:9000/MANAGER-SERVICE/projectMember/getProjectMember';
    //this.findProjectlByEmpIdURL = 'http://localhost:9000/ADMIN-VIEW-SERVICE/api/v1/getteams';
    this.findProjectlByEmpIdURL = 'http://localhost:9000/ADMIN-VIEW-SERVICE/api/v1//project_members/getEmp';
